...
const ITEM_DB = [
    ...
    { type: 'weapon', char: '\\', color: '#c0392b', name: 'Grond, the Hammer', effect: 'weapon', equip: true, atkBonus: 22, artifact: true, identified: true, minFloor: 13, cost: 15000 },
    { type: 'ring', char: CHARS.RING, color: '#e74c3c', name: 'Narya, Ring of Fire', effect: 'resist_fire', equip: true, atkBonus: 3, defBonus: 2, artifact: true, identified: true, minFloor: 10, cost: 8000 },
    { type: 'ring', char: CHARS.RING, color: '#3498db', name: 'Nenya, Ring of Water', effect: 'regeneration', equip: true, defBonus: 4, artifact: true, identified: true, minFloor: 11, cost: 10000 },
    { type: 'weapon', char: '|', color: '#9b59b6', name: 'Calris', effect: 'weapon', equip: true, atkBonus: 16, artifact: true, identified: true, element: 'magic', minFloor: 10, cost: 11000 },
    { type: 'armor', char: '[', color: '#f1c40f', name: 'Thorin, Shield of Durin', effect: 'armor', equip: true, defBonus: 10, artifact: true, identified: true, minFloor: 12, cost: 12000 },
